...
public class ProbabilityTable implements CategoricalDistribution, Factor {
	...
	public Map<RandomVariable, RVInfo> getRandomVarInfo() {
		return randomVarInfo;
	}



	public void setRandomVarInfo(Map<RandomVariable, RVInfo> randomVarInfo) {
		this.randomVarInfo = randomVarInfo;
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((randomVarInfo == null) ? 0 : randomVarInfo.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (randomVarInfo == null) {
			if (other.randomVarInfo != null)
				return false;
		} else if (!randomVarInfo.equals(other.randomVarInfo))
			return false;
		return true;
	}
